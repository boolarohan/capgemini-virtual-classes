...
public class ServiceRepo {
	...
	public void addSomeUsers()
	{
		...
		User user1=new User(101,"rohan","rohan@gmail.com",9999999999L);
		User user2=new User(102,"nived","nived@gmail.com",9999999998L);
		User user3=new User(103,"ravali","ravali@gmail.com",9999999997L);
		User user4=new User(104,"nithin","nithin@gmail.com",9999999996L);
